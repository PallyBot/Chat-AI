...
@InputType()
class SearchQueryCreateNestedManyWithoutConversationsInput {
...
export { SearchQueryCreateNestedManyWithoutConversationsInput as SearchQueryCreateNestedManyWithoutConversationsInput };
